	   ...
	   <div class="container">
		  <div class="register">
		  	<?php
				...
				$res=mysqli_query($con, "INSERT INTO menu_card (R_Id, Menu_Id, Dish_Name, Dish_Price, Dish_Available) VALUES ('$_SESSION[rid]', '$test_row[R_MenuId]', '$_POST[dname]','$_POST[dprice]','$_POST[davail]')");
